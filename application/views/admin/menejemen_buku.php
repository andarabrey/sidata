            ...
            <table class="table table-bordered table-hover table-striped" cellspacing="0" width="100%" id="myTable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="<?php echo base_url() ?>/admin/buku/hapus_buku/<?php echo $list_buku['id_buku'] ?>" class="btn btn-xs btn-danger demo-buku" data-toggle="confirmation">Hapus</a> <button class="btn btn-xs btn-warning" data-toggle="modal" data-target="#modalEdit_<?php echo $list_buku['id_buku'] ?>">Edit</button><a style="margin-left: 5px" target="blank" href="<?php echo base_url() ?>/upload/<?php echo $list_buku['file'] ?>" class="btn btn-xs btn-default">File</a> </td>
                </tr>
                <?php } ?>
              </tbody>
            </table>
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/buku/tambah" enctype="multipart/form-data">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="number" min="1900" max="<?php echo date("Y")?>" class="form-control" id="username" placeholder="Tahun Penerbitan" name="tahun">
              </div>
            </div>
            <div class="form-group">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/buku/edit_buku/<?php echo $list_buku01['id_buku'] ?>">
            <div class="box-body">
              ...
              <div class="form-group">
                <label for="inputPassword3" class="col-sm-3 control-label">Tahun Terbit</label>
                <div class="col-sm-9">
                  <input type="number" min="1900" max="<?php echo date("Y")?>" class="form-control" id="username" placeholder="Tahun Penerbitan" name="tahun" value="<?php echo $list_buku01['tahun_terbit'] ?>">
                </div>
              </div>
              <div class="form-group">
                <label for="inputPassword3" class="col-sm-3 control-label">Type</label>
